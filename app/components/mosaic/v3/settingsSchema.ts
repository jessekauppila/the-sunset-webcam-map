...
import type { V3Config } from './engine/types';
 ...
 */
export const V3_SETTINGS_SCHEMA: SettingsSchema = [
  {
...
/**
 * The motion dials, kept out of V3Config on purpose: the composition engine

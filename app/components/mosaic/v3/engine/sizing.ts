import type { SizedTile, TileInput, V3Config } from './types';
 ...
 */
export function normalizeScore(score: number, cfg: V3Config): number {
 ...
 */
export function sizeTiles(tiles: TileInput[], cfg: V3Config): SizedTile[] {

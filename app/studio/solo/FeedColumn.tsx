...
/**
 * One feed's two bins, each as three stages (in line, resting, under
 * floor), and its queue as the STUDIO dials would order them. The tape is
 * the panel's, above both columns, because a rendezvous is one line through
 * both screens (one-tape spec §4.1). With

...
See `docs/superpowers/specs/2026-05-15-streamlined-deployment-overview.md` for the umbrella decomposition. Sub-project F (`docs/superpowers/specs/2026-05-16-cloud-wizard-frontend-design.md`) is the wizard frontend; sub-project E (`docs/superpowers/specs/2026-05-15-wifi-onboarding-and-provisioning-design.md`) is the captive-portal WiFi onboarding that gets the device online before the wizard runs.
